...
*/
    ...
    void testNegativeNumsInExpr() {
        ...
        AST exp = new BinaryComputing(AST.Operators.PLUS,
                        new BinaryComputing(AST.Operators.MINUS, new HeltalLiteral("-5"),
                            new DecimaltalLiteral("-3,3")), new HeltalLiteral("-1"));
